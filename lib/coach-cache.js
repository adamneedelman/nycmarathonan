...
// Stores { [activityId]: terrainRecord } in the same shape as the notes key.
// Streams are immutable once uploaded, so each record is written once per
// activity and kept forever.
export const HILLS_KEY = 'coach:hills:v1';
