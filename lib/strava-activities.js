...
export function transformActivity(a) {
  ...
  const elevationGainFt = a.total_elevation_gain != null
    ? Math.round(a.total_elevation_gain * FEET_PER_METER) : null;
  return {
    id: a.id,
    ...
    elev_per_mile: elevationGainFt != null && distanceMiles > 0
      ? Math.round(elevationGainFt / distanceMiles) : null,
    name: a.name || '',
  };
}
